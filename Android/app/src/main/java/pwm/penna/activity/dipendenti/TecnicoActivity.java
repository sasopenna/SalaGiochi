...
public class TecnicoActivity extends ListActivity implements AsyncActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.title)).setText(R.string.tecnici);
    }

...
<div class="card">
    <div class="card-header pb-0 text-start">
        <h4 class="font-weight-bolder"><s:text name="managers.title.mod"/></h4>
        <p class="mb-0"><s:text name="managers.instructions.mod"/></p>
    </div>
    <div class="card-body">
        <s:form action="Aggiorna" method="post" role="form">
            <div class="mb-3">
                <h5 class="font-weight-bolder">
                    <s:text name="managers.manager"/>
                    <span class="badge badge-sm bg-gradient-info badge-padding">
                        <span class="text-uppercase text-white text-md font-weight-bolder"><s:property value="dirigente.idDipendente"/></span>
                    </span>
                </h5>
                <s:fielderror fieldName="dirigente.idDipendente" />
                <s:hidden name="dirigente.idDipendente" cssClass="form-control form-control-lg" required="true" />
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 bl-table">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <s:textfield name="dirigente.profilo.email" placeholder="%{getText('managers.email')}" cssClass="form-control form-control-lg" required="true" readonly="true" />
                    </div>
                </div>
			...
			<div class="text-center">
			    <s:submit cssClass="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" value="%{getText('managers.update')}"/>
			</div>
		</s:form>
	</div>
</div>

...
<div class="card">
    <div class="card-header pb-0 text-start">
        <h4 class="font-weight-bolder"><s:text name="devices.title.new"/></h4>
        <p class="mb-0"><s:text name="devices.instructions.new"/></p>
    </div>
    <div class="card-body">
        <s:form action="Crea" method="post" role="form">
			<div class="row">
				<div class="col-lg-4 mb-3">
                    ...
                    <s:select name="tipo" list="dispositivi" value="dispositivoDiGioco.getTipo()" cssClass="form-control form-control-lg" required="true" />
				</div>
				<div class="col-lg-4">
                    ...
                    <div class="col-lg-12 mb-3" id="sezionePlay">
                        <s:text name="devices.gen"/>
                        <s:fielderror fieldName="discriminator" />
                        <s:select name="discriminator" id="play" list="discriminatorPlayStation" value="dispositivoDiGioco.genenerazione" cssClass="form-control form-control-lg" required="true" />
                    </div>
				</div>
				<div class="col-lg-4">
            ...
            <div class="text-center">
                <s:submit cssClass="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" value="%{getText('devices.insert')}"/>
            </div>
        </s:form>
    </div>
</div>

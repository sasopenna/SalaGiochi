...
<div class="card">
    <div class="card-header pb-0 text-start">
        <h4 class="font-weight-bolder"><s:text name="members.title.new"/></h4>
        <p class="mb-0"><s:text name="members.instructions.new"/></p>
    </div>
	<div class="card-body">
		<s:form action="Crea" method="post" role="form">
			<div class="mb-3">
			    <span class="text-uppercase text-secondary text-sm font-weight-bolder"><s:text name="members.client_number"/></span>
			    <s:fielderror fieldName="socio.cliente.numeroCliente" />
			    <s:select name="socio.cliente.numeroCliente" list="notSoci" cssClass="form-control form-control-lg" required="true" />
			</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 bl-table">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <s:textfield name="socio.profilo.email" placeholder="%{getText('members.e-mail')}" cssClass="form-control form-control-lg" required="true" />
                    </div>
                </div>
            ...
            <div class="text-center">
                <s:submit cssClass="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" value="%{getText('members.insert')}"/>
            </div>
		</s:form>
	</div>
</div>

...
<div class="card">
    <div class="card-header pb-0 text-start">
        <h4 class="font-weight-bolder"><s:text name="cashiers.title.new" /></h4>
        <p class="mb-0"><s:text name="cashiers.instructions.new" /></p>
    </div>
    <div class="card-body">
        <s:form action="Crea" method="post" role="form">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 bl-table">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <s:textfield name="cassiere.profilo.email" placeholder="%{getText('cashiers.e-mail')}" cssClass="form-control form-control-lg" required="true" />
                    </div>
                </div>
            ...
            <div class="text-center">
                <s:submit cssClass="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" value="%{getText('cashiers.insert')}" />
            </div>
        </s:form>
    </div>
</div>
